...
-define(DEFAULT_ADMIN_NAME, proplists:get_value(name, application:get_env(emq_dashboard, default_admin, []))).
-define(DEFAULT_ADMIN_PASS, proplists:get_value(password, application:get_env(emq_dashboard, default_admin, []))).
